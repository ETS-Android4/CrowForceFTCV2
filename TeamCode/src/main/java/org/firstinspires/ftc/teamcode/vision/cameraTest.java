...
public class cameraTest {
    ...
    private volatile cameraTest.MarkerPosition position = cameraTest.MarkerPosition.LEFT;
    ...
    public void main(String args) {
        mainProcess("MarkerIMG1.png");
        System.out.println(position);
    }

    public Mat mainProcess(String fileName) {
        /*
         ...
         */
        region1_Cb = V.submat(new Rect(region1_pointA, region1_pointB));
        region2_Cb = V.submat(new Rect(region2_pointA, region2_pointB));
        region3_Cb = V.submat(new Rect(region3_pointA, region3_pointB));
        ...
        {
            position = cameraTest.MarkerPosition.LEFT; // Record our analysis
        ...
        {
            position = cameraTest.MarkerPosition.CENTER; // Record our analysis
        ...
        {
            position = cameraTest.MarkerPosition.RIGHT; // Record our analysis
